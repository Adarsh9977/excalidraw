      ...
      <main className="p-4 sm:p-6 space-y-6 sm:space-y-8 min-h-screen">
        <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="text-neutral-400 font-light text-sm">Manage your team members and invite new collaborators to your Excalidraw projects</p>
          </div>
          ...
          <Suspense fallback={<CollaboratorsLoading />}>
            ...
            {collaborators.data.length === 0 && (
                <div className="flex flex-col items-center justify-center gap-2 w-full py-24">
                  <h2 className="text-[#009758] font-bold text-2xl">No collaborators yet</h2>
                  <p className="text-neutral-400 font-light text-sm">Invite your teammates to join</p>
                </div>
              )}
          </Suspense>
        </section>
